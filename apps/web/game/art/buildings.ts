...
export const ART: Record<BuildingType, BuildingArtFn> = {
  keep(c, b, t) {
    ...
    if (lv >= 5) roof(c, b.gx + 1.25, b.gy + 1.25, 1.5, 1.5, 80, 24, '#e0b23a', '#a8781a', '#ffd977');
    else roof(c, b.gx + 1.25, b.gy + 1.25, 1.5, 1.5, 80, 24, '#c8402f', '#a33325', '#f07a5a');
    ...
    if (lv >= 2) {
      ...
      for (const u of [0.32, 0.68]) {
        ...
        c.beginPath();
        c.moveTo(bp.x - 4, bp.y - 52);
        c.lineTo(bp.x + 4, bp.y - 52);
        c.lineTo(bp.x + 4, bp.y - 33);
        c.lineTo(bp.x, bp.y - 37);
        c.lineTo(bp.x - 4, bp.y - 33);
        c.closePath();
        c.fill();
  ...
  vault(c, b, _t) {
    ...
    if (lv >= 3) {
      ...
      for (const q of [tA, tB]) {
        c.fillStyle = '#8f97a5';
        c.beginPath();
        c.moveTo(q.x - 4, q.y - 31);
        c.lineTo(q.x + 4, q.y - 31);
        c.lineTo(q.x, q.y - 22);
        c.closePath();
        c.fill();
    ...
    for (const u of [0.26, 0.74]) {
      ...
      poly(c, [p1, p2, { x: p2.x, y: p2.y - 31 }, { x: p1.x, y: p1.y - 31 }], lv >= 5 ? '#7d5406' : '#2e3540');
  ...
  tank(c, b, t) {
    ...
    c.stroke();
    const cap = prism(c, b.gx + 0.68, b.gy + 0.68, 1.64, 1.64, 4, '#454d5c', '#23272f', '#343b48', 37);
    if (lv >= 4) {
  ...
  cannon(c, b, t) {
    ...
    c.beginPath();
    c.moveTo(-rec - 4, -8);
    c.lineTo(barrelLen - rec, -8);
    c.arc(barrelLen - rec, 0, 8, -Math.PI / 2, Math.PI / 2);
    c.lineTo(-rec - 4, 8);
    c.closePath();
    c.fill();
    ...
    c.stroke();
    c.fillStyle = '#3d4452';
    c.fillRect(-rec - 4, -8, barrelLen + 4, 4);
    ...
    c.fillStyle = '#0c0e12';
    c.beginPath();
    c.arc(barrelLen + 2 - rec, 0, 5, 0, 7);
    c.fill();
    c.strokeStyle = lv >= 5 ? '#d8b25c' : '#4a5160';
    c.lineWidth = 1.6;
    c.beginPath();
    c.arc(barrelLen + 2 - rec, 0, 6.6, 0, 7);
    c.stroke();
    c.fillStyle = '#232833';
    c.beginPath();
  ...
  arrow(c, b, _t) {
    ...
    if (lv >= 2) {
      ...
      c.beginPath();
      c.moveTo(bp.x - 4, bp.y - 48);
      c.lineTo(bp.x + 4, bp.y - 48);
      c.lineTo(bp.x + 4, bp.y - 28);
      c.lineTo(bp.x, bp.y - 32);
      c.lineTo(bp.x - 4, bp.y - 28);
      c.closePath();
      c.fill();
    ...
    if (lv >= 4) {
      ...
      c.lineWidth = 1.8;
      c.beginPath();
      c.moveTo(e1.x, e1.y - 61);
      c.lineTo(e2.x, e2.y - 61);
      c.lineTo(e3.x, e3.y - 61);
      c.stroke();
    }
  ...
  mortar(c, b, _t) {
    ...
    c.fillStyle = '#1c2027';
    c.beginPath();
    c.ellipse(cp.x, cp.y - 9, R, R * 0.555, 0, 0, 7);
    c.fill();
    c.fillRect(cp.x - R, cp.y - 22, R * 2, 13);
    c.beginPath();
    c.ellipse(cp.x, cp.y - 22, R, R * 0.555, 0, 0, 7);
    c.fill();
    c.strokeStyle = 'rgba(8,10,13,.8)';
    c.lineWidth = 1.6;
    c.beginPath();
    c.moveTo(cp.x - R, cp.y - 9);
    c.lineTo(cp.x - R, cp.y - 22);
    c.moveTo(cp.x + R, cp.y - 9);
    c.lineTo(cp.x + R, cp.y - 22);
    c.stroke();
    ...
    c.fillStyle = '#05070a';
    c.beginPath();
    c.ellipse(cp.x, cp.y - 23, R - 4.5, R * 0.555 - 2.7, 0, 0, 7);
    c.fill();
    c.strokeStyle = '#d8b25c';
    c.lineWidth = 1.8;
    c.beginPath();
    c.ellipse(cp.x, cp.y - 15.5, R, R * 0.555, 0, lv >= 2 ? 0 : 0.5, lv >= 2 ? 7 : 2.6);
    c.stroke();
    if ((b.flash ?? 0) > 0) {
  ...
  barracks(c, b, t) {
    ...
    const M2 = lv >= 5
      ? roof(c, b.gx + 0.45, b.gy + 0.85, 2.1, 1.6, 20, 20, '#e0b23a', '#a8781a', '#ffd977', 0.2)
      : roof(c, b.gx + 0.45, b.gy + 0.85, 2.1, 1.6, 20, 20, '#c8402f', '#a33325', '#f07a5a', 0.2);
    if (lv >= 4) {
      // gold eaves trim
      c.strokeStyle = '#e9b93c';
      c.lineWidth = 1.8;
  ...
  camp(c, b, t) {
    ...
    roof(c, b.gx + 0.45, b.gy + 2.25, 1.3, 1.15, 9, 13, lv >= 5 ? '#e0b23a' : '#c8402f', lv >= 5 ? '#a8781a' : '#a33325', lv >= 5 ? '#ffd977' : '#f07a5a', 0.12);

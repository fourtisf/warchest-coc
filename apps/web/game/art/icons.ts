...
export function getIcon(kind: 'b' | 't', key: string): HTMLCanvasElement {
  ...
  if (kind === 'b') {
    ...
    const HH: Record<string, number> = { keep: 128, arrow: 106, tank: 80, mine: 78, well: 64, vault: 62, cannon: 60, mortar: 52, barracks: 74, camp: 62, hut: 56, wall: 32, bomb: 26, spring: 24 };
